                        ...
                        <div class="panel widget">
                            ...
                            <div  class="search-filter">
                                ...
                                <div class="row">
                                    ...
                                    <form action="<?= $this->config->base_url() . 'user/rides' ?>" method="get">
                                        ...
                                        <div class="col-md-2" style="margin-top:25px">
                                            ...
                                            <a style="margin-left:5px" href="<?= $this->config->base_url() . 'user/rides' ?>" class="btn btn-re" ><i class="fa fa-refresh" aria-hidden="true"></i></a>
