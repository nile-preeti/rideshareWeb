    ...
    function set_marker(features) {
        ...
        features.forEach(function (feature) {
           ...
           var content = '<div id="iw-container">' +
                ...
                '<img src="<?= base_url('uploads/profile_image/') ?>' +feature.user_id+'/'+feature.avatar+ '" alt="Profile" height="115" width="83">' +
                '<div class="iw-subTitle">Contacts</div>' +
                '<p>Phone: ' + feature.mobile + '</p><p> E-mail: ' + feature.email  +'</p><p> Vehicle No: ' + feature.vehicle_no  +'</p><p> Color: ' + feature.color  +
                '</p></div>' +
