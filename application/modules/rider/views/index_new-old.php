                        ...
                        <div class="vd_content-section clearfix">
                            <div class="panel widget light-widget">
                                <div class="panel-heading vd_bg-grey">
                                    <h3 class="panel-title" style="color:#fff"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Ride Detail </h3>
                                </div>
                                        ...
                                        <div  class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <p class="text-right"><a href="#" class="btn btn-success">Audio Captured</a></p> 
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
