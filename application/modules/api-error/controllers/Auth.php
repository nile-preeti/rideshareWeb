...
class Auth extends BD_Controller {
	...
	/*#################
	get_vehicle type List distance with time 
	############*/
...
*/
	...
	{ 
		...
		$distanceMile = bcadd($distance, 0,2);
        ...
        if (empty($distance)) {
            ...
            return  array('status'=>true,'distance' => $distanceMile * 0.000621371192, 'time' => $durationTime);
