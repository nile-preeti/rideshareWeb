                        ...
                        <div class="panel widget">
                            ...
                            <div  class="search-filter">
                                ...
                                <div class="row">
                                    ...
                                    <form action="<?= $this->config->base_url() . 'admin/riders_ride'.'/'.$rider_id; ?>" method="get">
											

                                        <input type="hidden" name="riderid" value="<?php echo!empty($filter_data[$rider_id]) ? $filter_data[$rider_id] : ''; ?>" />    
                                        ...
                                        <div class="col-md-2" style="margin-top:25px">
                                            ...
                                            <a style="margin-left:5px" href="<?= $this->config->base_url() . 'admin/riders_ride'.'/'.$rider_id; ?>" class="btn btn-re" ><i class="fa fa-refresh" aria-hidden="true"></i></a>
