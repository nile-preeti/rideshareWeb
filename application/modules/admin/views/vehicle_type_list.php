                            ...
                            <table id="example" class="table display border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        $base_fee=$row->base_fare_fee;
                                        $per_MileFee =($row->rate)? $row->rate:$per_MileFee;   
                                        $tax=($row->taxes)? $row->taxes:$tax;
                                        $surchargeFee =($row->surcharge_fee)?$row->surcharge_fee:$surchargeFee;
                                       
                                        $cancaltionfee= $row->cancellation_fee;
                                        $totalsubprice = ($base_fee + $per_MileFee + $surchargeFee);
                                        $taxval = ($tax / 100) * $totalsubprice; 
                                        $totalprice = (number_format((float)$taxval,2)+number_format((float)$totalsubprice,2));
                                         ?-->
