                        ...
                        <table id="example" class="table display ">
                           ...
                           <tbody>
                              ...
                              <tr>
                                ...
                                <td><?= $val->status == 1 ? '<span id="span" class="label label-success">Active</span>' : '<span id="span" class="label label-Deactive">Inactive</span>'; ?></td>
                                ...
                                <td><span class="menu-action hiderow<?= $val->user_id ?>"><a id="<?= $val->user_id ?>" data-original-title="change_password" data-toggle="tooltip" data-placement="top" class="btnaction btn menu-icon  vd_bd-yellow vd_yellow"> <i class="fa fa-key"></i> </a> <a id="<?= $val->user_id ?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btnaction btn menu-icon  vd_bd-yellow vd_yellow"> <i class="fa fa-pencil"></i> </a> <a id="<?= $val->user_id ?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btnaction btn menu-icon vd_bd-red vd_red"> <i class="fa fa-times"></i> </a></span></td>
                              ...
                              <?php
                                 ...
                                 <tr><td colspan="9" style="text-align:center"><h3>No record found</h3></td></tr>
                                <?php  } ?>
