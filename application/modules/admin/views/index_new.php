...
<!-- ride pick and drop location map data commented on 15-12-23 start -->
...
<!--script type="text/javascript">
    ...
    var icon = {
        ...
        //url: "https://firebasestorage.googleapis.com/v0/b/api-project-796350111526.appspot.com/o/gps.svg?alt=media&token=AIzaSyCqe-qOeVeBJdJDqckwLP_XImkSlpcfte4", //last Ridesharerates till 31-10-2023
        //url: "https://firebasestorage.googleapis.com/v0/b/api-project-796350111526.appspot.com/o/gps.svg?alt=media&token=def31471-155c-4d9a-9a46-d428459517c0",
...
<!-- ride pick and drop location map data commented on 15-12-23 end -->
</head>
<body onLoad="initMap()">
                                        ...
                                        <div  class="search-filter">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <p class="inline"><?php echo ($detail->amount)?DEFAULT_CURRENCY.' '. $detail->amount:'NA';?></p>
                                                </div>
                                                <div class="col-md-6">
                                                   <label class="inline">Distance: </label> 
                                                   <p class="inline"><?php echo ($detail->distance)?$detail->distance.' '. 'Miles':'';?></p>
                                                </div>
                                                <div class="col-md-6">
												...
												<div class="col-md-6">
                                                   <label class="inline">Hold Amount: </label>
                                                    <p class="inline"><?php echo ($detail->hold_amount)?$detail->hold_amount:'';?></p> 
                                                </div>
												
												<div class="col-md-6">
                                                   <label class="inline">Ride_amount: </label>
                                                    <p class="inline"><?php echo ($detail->amount)?$detail->amount:'';?></p> 
                                                </div>
												
												<div class="col-md-6">
                                                   <label class="inline">Rest Amount: </label>
                                                    <p class="inline"><?php echo ($detail->rest_amount)?$detail->rest_amount:'';?></p> 
                                                </div>
												
												<div class="col-md-6">
                                                   <label class="inline">Transection Id: </label>
                                                    <p class="inline"><?php echo ($detail->txn_id)?$detail->txn_id:'';?></p> 
                                                </div>
                                                <!-- <div class="col-md-12">                           
