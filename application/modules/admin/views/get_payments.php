                                   ...
                                   <form action="<?= $this->config->base_url() . 'admin/getPayments' ?>" method="get">
                                      ...
                                      <div class="col-md-2" style="margin-top:25px">
                                         ...
                                         <?php if(isset($filter_data['name'])){?>
                                            ...
                                            <a style="margin-left:5px;background: #ecfdd2;color:#FB8904" href="<?= $url.'&export=true' ?>" class="btn btn-re" ><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>

                                         <?php }else{ ?>

                                            <a style="margin-left:5px;background: #ecfdd2;color:#FB8904;
" href="<?= $url.'?export=true' ?>" class="btn btn-re" ><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
