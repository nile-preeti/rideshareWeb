	                                         ...
	                                         <div class="col-md-10">
	                                         	<div class="row">
													...
													<div class="col-md-4 mb-10 label-H">
			                                            ...
			                                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter last Name" value="<?php echo $post['last_name']; ?>">
												...
												<div class="row">
			                                        <div class="col-md-4 mb-10 label-H px-1">
														...
														<div class="form-group mt-2">
															<div class="two-form-group">
																...
																<div class="select-input-card">
																	<input type="text" class="form-control" id="mobile" placeholder="Mobile" name="mobile" value="<?php echo $post['mobile']; ?>" onInput="this.value = phoneFormat(this.value)" min="9" max="14">
																</div>
															</div>
			                                        ...
			                                        <div class="col-md-4 mb-10 label-H ">
			                                           ...
			                                           <select class="form-control" name="verification_id_approval_status">
												...
												<div class="row">
			                                        <div class="col-md-4 mb-10 label-H px-1">
			                                            ...
			                                            <select class="form-control" name="background_approval_status">
													...
													<div class="col-md-4 mb-10 label-H ">
			                                            <label class="control-label status_dark">SSN Number<span class="text-danger">*</span></label>
			                                            <input type="text" class="form-control" id="ssn" name="ssn" placeholder="Enter SSN Number" value="<?php echo $post['ssn']; ?>">
			                                            <?php echo form_error('email'); ?>
			                                        </div>
													...
													<div class="col-md-4 mb-10 label-H">
			                                            ...
			                                            <select class="form-control" name="user_status">
			                                                <option value="1" <?php echo ($post['status']==1)?'selected':'';?>>Active</option>
			                                                <option value="2" <?php echo ($post['status']==2)?'selected':'';?>>Need to email verification</option>
			                                                <option value="3" <?php echo ($post['status']==3)?'selected':'';?>>Need to admin approval</option>
			                                                <option value="3" <?php echo ($post['status']==4)?'selected':'';?>>Inactive by admin</option>
			                                            </select>
	                                        	...
	                                        	<div class="uploads-driver-box-info">
	                                        		<div class="row">
	                                        			<div class="col-md-2">                                                
			                                            	...
			                                            	<input type="file" class="form-control cmb-1" id="identity_document" name="identity_document" value=""> 
				                                        ...
				                                        <div class="col-md-10">
				                                        	<div class="row">
						                                        <div class="col-md-4 mb-10 px-1">
			                                                        <div id="image-div">
			                                                        <label class="control-label" style="color:red">Identity document status</label>
				                                                ...
				                                                <div class="col-md-4">
				                                                    <label class="control-label ">Identity document expire date</label>
                                    ...
                                    <?php if ($vehicle_query->num_rows()>0) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-10 label-H">
                                                <label for="brand" class="status_dark"> Vehicle Category<span class="text-danger">*</span></label>
                                                ...
                                                <label for="rate">Per mile rate($)<span class="text-danger">*</span></label>
                                                    ...
                                                    <?php $query = get_table_record(Tables::VEHICLE_SUBCATEGORY_TYPE,array('status'=>1,'vehicle_type_category_id'=>$row->brand_id),'id,title,rate');
														...
														<?php if($value->id==$row->model_id){?>
															<input type="text" class="form-control" id="rate" placeholder="" name="rate[]" value="<?php echo $value->rate;?>" readonly />
														<?php  }} ?>
                                            ...
                                            <div class="col-md-4 mb-10 label-H">
                                                ...
                                                <div id="email-input-wrapper"  class="controls ">    
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-10">
                                                            <div id="image-div">
                                                                <label class="control-label status_dark" style="color:red">Licence aprove Status</label>
                                                                <select class="form-control" name="license_approve_status">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="control-label ">Licence expire date</label>
                                            ...
                                            <div class="col-md-4 mb-10 label-H">
                                                ...
                                                <div id="email-input-wrapper"  class="controls ">                                            
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-10">
                                                            <div id="image-div">
                                                            <label class="control-label status_dark" style="color:red">Insurance aprove Status</label>
                                                                <select class="form-control" name="insurance_approve_status">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label class="control-label status_dark">Insurance start date </label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="control-label status_dark">Insurance expire date</label>
                                            ...
                                            <div class="col-md-4 mb-10 label-H">
                                                ...
                                                <div id="email-input-wrapper"  class="controls ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-10">
                                                            <div id="image-div">
                                                            <label class="control-label status_dark" style="color:red">Car Registration approve satatus</label>
                                                                <select class="form-control" name="car_registration_approve_status[]">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="control-label ">Car expire date</label>
                                            ...
                                            <div class="col-md-4 mb-10 label-H">
                                                ...
                                                <div id="email-input-wrapper"  class="controls ">    
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-10">
                                                            <div id="image-div">
                                                            <label class="control-label status_dark" style="color:red">Inspection document status</label>
                                                                <select class="form-control" name="inspection_approval_status[]">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="control-label ">Inspection document expire date</label>
