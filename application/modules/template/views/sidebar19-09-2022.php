                ...
                <div class="vd_menu">
                    ...
                    <ul>
                       ...
                       <!--  <li>
                        ...
                        <li class="<?php echo ($this->router->fetch_method()=='users')?'active':'';?>">
                            <a  href="<?php echo $this->config->base_url() ?>admin/users">
                        ...
                        <li class="<?php echo ($this->router->fetch_method()=='getPayments')?'active':'';?>">
                         ...
                         <li class="<?php echo ($this->router->fetch_method()=='payout')?'active':'';?>">
                            <a  href="<?php echo $this->config->base_url() ?>admin/payout">
