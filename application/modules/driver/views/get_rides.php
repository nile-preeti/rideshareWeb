                ...
                <div class="panel widget oc-panel light-widget">
                   ...
                   <div class="panel-heading">
                    ...
                    <?php if (!empty($result)) { ?>
                        <div class="panel widget">
                            ...
                            <div  class="search-filter">
                                ...
                                <div class="row">
                                    ...
                                    <form action="<?= $this->config->base_url() . 'driver/rides' ?>" method="get">



                                        <div class="col-md-2 label-H" >

                                            <label>Search from driver OR user</label>
                                        ...
                                        <div class="col-md-2" style="margin-top:25px">
                                            ...
                                            <a style="margin-left:5px" href="<?= $this->config->base_url() . 'rider/rides' ?>" class="btn btn-re" ><i class="fa fa-refresh" aria-hidden="true"></i></a>
                        ...
                        <?php }else{ ?>
                                <tr>        
                                    <td><h3>There is no ride available here</h3></td>
                                </tr>
                        <?php } ?>
