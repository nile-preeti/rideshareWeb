                ...
                <h2 class="mgbt-xs-5"><b><img src="<?php echo base_url('assets/images/logo.png')?>" alt="Ride Share Rate" height="100"></b></h2><br/>
                    ...
                    <div class="panel widget">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="<?php echo  base_url('driver_login');?>" method="post" role="form">
                                ...
                                <p><a href="javascript:void(0);" class="" id="forgot-password-driver">Forgot Password</a></p>
