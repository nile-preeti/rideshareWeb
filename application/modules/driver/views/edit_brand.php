                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel widget">
                            ...
                            <div  class="search-filter">
                                ...
                                <form action="<?php echo base_url('admin/edit_brand');?>" method="post">
                                    ...
                                    <div  class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="brand_name" placeholder="Name" name="brand_name" value="<?php echo ($row)?$row->brand_name:''; ?>">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="status" class="form-control"  id="status">
                                                ...
                                                <option value="1" <?php echo ($row)?($row->status==1)?'selected':'':'';?>>Active</option>

                                                <option value="2" <?php echo ($row)?($row->status==2)?'selected':'':'';?>>Inactive</option>
                                        ...
                                        <div class="col-md-12 mt-20">
                                            ...
                                            <a href="<?php echo base_url('admin/brand_list');?>"><button type="button" class="btn btn-gr">Back</button></a>
